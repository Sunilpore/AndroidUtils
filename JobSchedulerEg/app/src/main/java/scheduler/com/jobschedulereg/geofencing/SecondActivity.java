...
import scheduler.com.jobschedulereg.R;
...
public class SecondActivity extends AppCompatActivity implements LocationListener {
    ...
    //18.9943102,72.8206826
    double currentLatitude = 18.9943102, currentLongitude = 72.8206826;
    ...
    private GoogleApiClient.ConnectionCallbacks connectionAddListener =
            new GoogleApiClient.ConnectionCallbacks() {
                ...
                public void onConnected(Bundle bundle) {
                    ...
                    if (location == null) {
                        LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, SecondActivity.this);
    ...
    public void createGeofences(double latitude, double longitude) {
        ...
        Geofence fence = new Geofence.Builder()
                ...
                .setCircularRegion(latitude, longitude, 5)
    ...
    private PendingIntent getGeofencePendingIntent() {
        ...
        Intent intent;
        intent = new Intent(this, GeofenceTransitionsService.class);

        /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            intent = new Intent(this, LocationJobService.class);
